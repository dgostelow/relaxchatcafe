...
<?php if (get_option('ab_settings_coupons')): ?>
    <div style="margin-bottom: 15px!important;" class="ab-row-fluid" id="ab-info-text-coupon"><?php echo $info_text_coupon ?></div>
    <div class="ab-row-fluid ab-list">
        <div class="ab-formGroup ab-full ab-lastGroup">
            <span style="display: inline-block;"><?php echo esc_html(get_option( 'ab_appearance_text_label_coupon' )); ?></span>
...
<?php if ($_paypal) : ?>
    <div class="ab-row-fluid ab-list">
        ...
        <?php if (isset($error_msg) && !empty($error_msg)): ?>
            <div class="ab-select-service-error ab-bold" style="padding-top: 5px;">* <?php echo $error_msg; ?></div>
        <?php endif; ?>
    </div>
<?php endif ?>
